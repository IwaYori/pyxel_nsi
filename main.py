...
class Menu:
    def __init__(self):
        # initialisation de la liste des couleurs possibles, on excluera le vert qui est la couleur du terrain
        self.colors = [1,2,4,5,6,8,9,10,12,13,14,15]
        # par défaut, joueur1 = colors[3] = 5 (bleu), joueur2 colors[5] = 8 (rouge)
        self.col1_id = 3
        self.col2_id = 5
